...
//! - `KEEL_DISABLE_SOUND` env kill-switch + the `soundEnabled` ui-setting;
...
const DISABLE_ENV: &str = "KEEL_DISABLE_SOUND";
...
fn temp_path() -> PathBuf {
    ...
    std::env::temp_dir().join(format!("keel-sound-{}-{id}.wav", std::process::id()))
}
