...
//! (keel settings.devices.tsx / settings.agents.tsx / settings.archived.tsx).
...
/// title + `text-[13px]` count sharing a baseline (keel settings.devices.tsx).
...
/// Display-only toggle switch (keel branch-picker.tsx `Toggle`): an 18×32
