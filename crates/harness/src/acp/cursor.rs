...
//!
//! Keel opts into parameterized mode. Auto's Intelligence / Balance / Cost
...
use keel_proto::{Model, ModelOption, ModelOptionChoice, ReasoningLevel};
...
/// Keel can render — so callers put it on the description subline (or fold
...
/// Rewrite the wire model list into Keel's picker shape.
...
/// Preference-ordered effort tokens for a Keel reasoning pick, used when
