...
//! of [`keel_sync::chat_client::ChatDocSink`] and
//! [`keel_sync::chat_client::CheckpointFetcher`], binding a
...
use keel_doc::SessionDoc;
use keel_sync::chat_client::{ChatDocSink, CheckpointFetcher};
use keel_sync::{DocsStore, SyncError};
