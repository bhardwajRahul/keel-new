...
//! (`keel_doc::apply_op`). Test infrastructure only (`mock-server` feature):
//! keel-sync's client tests and keel-engine's two-engine integration tests
...
use keel_doc::{RegistryRow, RowOp, apply_op};
