...
//! [`keel_doc::RegistryDoc`] under a lock. Wire frames are JSON text —
...
use keel_doc::{PendingBatch, RegistryDoc, RegistryRow, StateOutcome};
...
// ── stats (RoomStatsSnapshot-compatible so SyncStatus/`keel sync` render it) ─
