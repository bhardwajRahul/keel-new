...
use keel_doc::{REGISTRY_DOC_ID, RegistryDoc};
use keel_proto::{Chat, Device, Session, SessionStatus};
use keel_sync::registry::mock_server::MockRegistryServer;
use keel_sync::{DocsStore, RegistryClient, RegistryEvent};
